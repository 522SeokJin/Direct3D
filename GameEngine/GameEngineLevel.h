...
template<typename ActorType>
inline ActorType* GameEngineLevel::CreateActor(std::string _Name, bool _IsFind, int _UpdateOrder)
{
	GameEngineActor* NewActor = new ActorType();
...
template<typename ActorType>
inline ActorType* GameEngineLevel::FindActor(std::string _Name)
{
